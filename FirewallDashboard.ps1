...
<#
    ...
    ----------------------------------------------------------------
      Imkoniyatlar:
        ...
        - MASOFAVIY KIRISH: RDP va SSH'ni yoqish/o'chirish, portlarni ochish
...
$tabRemote  = New-Tab "Masofaviy kirish"
...
# ==============================================================
#  TAB — Masofaviy kirish (RDP / SSH / portlar)
# ==============================================================
$fontMono9 = New-Object System.Drawing.Font("Consolas",9)
$pnlRem            = New-Object System.Windows.Forms.Panel
$pnlRem.Dock       = 'Fill'; $pnlRem.AutoScroll = $true; $pnlRem.BackColor = $clrBg
$tabRemote.Controls.Add($pnlRem)

$lblScope          = New-Object System.Windows.Forms.Label
$lblScope.Text     = "Kimga ochiq:"; $lblScope.Location = New-Object System.Drawing.Point(12,14); $lblScope.AutoSize = $true
$pnlRem.Controls.Add($lblScope)

$cmbScope             = New-Object System.Windows.Forms.ComboBox
$cmbScope.Location    = New-Object System.Drawing.Point(100,10); $cmbScope.Size = New-Object System.Drawing.Size(280,24)
$cmbScope.DropDownStyle = 'DropDownList'
[void]$cmbScope.Items.AddRange(@("Faqat lokal tarmoq (tavsiya etiladi)","Hamma manzillar (xavfli)")); $cmbScope.SelectedIndex = 0
$pnlRem.Controls.Add($cmbScope)

$btnRemRefresh           = New-Object System.Windows.Forms.Button
$btnRemRefresh.Text      = "Holatni yangilash"; $btnRemRefresh.Size = New-Object System.Drawing.Size(150,28)
$btnRemRefresh.Location  = New-Object System.Drawing.Point(395,8); $btnRemRefresh.FlatStyle = 'Flat'; $btnRemRefresh.ForeColor = $clrText
$pnlRem.Controls.Add($btnRemRefresh)

function New-RemoteCard($title, $x) {
    $p = New-Object System.Windows.Forms.Panel
    $p.Size = New-Object System.Drawing.Size(490,210); $p.Location = New-Object System.Drawing.Point($x,48); $p.BackColor = $clrPanel
    $pnlRem.Controls.Add($p)
    $t = New-Object System.Windows.Forms.Label
    $t.Text = $title; $t.Font = $fontBold; $t.Location = New-Object System.Drawing.Point(12,10); $t.AutoSize = $true
    $p.Controls.Add($t)
    $st = New-Object System.Windows.Forms.Label
    $st.Font = $fontBold; $st.Location = New-Object System.Drawing.Point(12,36); $st.AutoSize = $true
    $p.Controls.Add($st)
    $d = New-Object System.Windows.Forms.Label
    $d.Font = $fontMono9; $d.Location = New-Object System.Drawing.Point(12,60); $d.Size = New-Object System.Drawing.Size(466,96)
    $p.Controls.Add($d)
    $on = New-Object System.Windows.Forms.Button
    $on.Text = "Yoqish"; $on.Size = New-Object System.Drawing.Size(140,32); $on.Location = New-Object System.Drawing.Point(12,165)
    $on.FlatStyle = 'Flat'; $on.BackColor = $clrGreen; $on.ForeColor = $clrText
    $p.Controls.Add($on)
    $off = New-Object System.Windows.Forms.Button
    $off.Text = "O'chirish"; $off.Size = New-Object System.Drawing.Size(140,32); $off.Location = New-Object System.Drawing.Point(162,165)
    $off.FlatStyle = 'Flat'; $off.BackColor = $clrRed; $off.ForeColor = $clrText
    $p.Controls.Add($off)
    return @{ State = $st; Detail = $d; On = $on; Off = $off }
}
$cardRdp = New-RemoteCard "RDP — Remote Desktop"  12
$cardSsh = New-RemoteCard "SSH — OpenSSH Server"  514

$pnlPorts           = New-Object System.Windows.Forms.Panel
$pnlPorts.Size      = New-Object System.Drawing.Size(992,112); $pnlPorts.Location = New-Object System.Drawing.Point(12,270)
$pnlPorts.BackColor = $clrPanel
$pnlRem.Controls.Add($pnlPorts)

$lblPorts          = New-Object System.Windows.Forms.Label
$lblPorts.Text     = "Boshqa portni ochish (kiruvchi):"; $lblPorts.Font = $fontBold
$lblPorts.Location = New-Object System.Drawing.Point(12,10); $lblPorts.AutoSize = $true
$pnlPorts.Controls.Add($lblPorts)

$txtOpenPort           = New-Object System.Windows.Forms.TextBox
$txtOpenPort.Location  = New-Object System.Drawing.Point(12,40); $txtOpenPort.Size = New-Object System.Drawing.Size(100,24)
$txtOpenPort.BackColor = $clrBg; $txtOpenPort.ForeColor = $clrText
$pnlPorts.Controls.Add($txtOpenPort)

$cmbOpenProto             = New-Object System.Windows.Forms.ComboBox
$cmbOpenProto.Location    = New-Object System.Drawing.Point(122,40); $cmbOpenProto.Size = New-Object System.Drawing.Size(70,24)
$cmbOpenProto.DropDownStyle = 'DropDownList'; [void]$cmbOpenProto.Items.AddRange(@('TCP','UDP')); $cmbOpenProto.SelectedIndex = 0
$pnlPorts.Controls.Add($cmbOpenProto)

$btnOpenPort           = New-Object System.Windows.Forms.Button
$btnOpenPort.Text      = "Ochish"; $btnOpenPort.Size = New-Object System.Drawing.Size(100,28)
$btnOpenPort.Location  = New-Object System.Drawing.Point(202,38); $btnOpenPort.FlatStyle = 'Flat'
$btnOpenPort.BackColor = $clrGreen; $btnOpenPort.ForeColor = $clrText
$pnlPorts.Controls.Add($btnOpenPort)

$btnClosePort           = New-Object System.Windows.Forms.Button
$btnClosePort.Text      = "Yopish"; $btnClosePort.Size = New-Object System.Drawing.Size(100,28)
$btnClosePort.Location  = New-Object System.Drawing.Point(310,38); $btnClosePort.FlatStyle = 'Flat'
$btnClosePort.BackColor = $clrRed; $btnClosePort.ForeColor = $clrText
$pnlPorts.Controls.Add($btnClosePort)

$lblPortHint           = New-Object System.Windows.Forms.Label
$lblPortHint.Text      = "masalan: 8080  yoki  5000-5100"
$lblPortHint.Location  = New-Object System.Drawing.Point(12,76); $lblPortHint.AutoSize = $true
$lblPortHint.ForeColor = [System.Drawing.Color]::Gray
$pnlPorts.Controls.Add($lblPortHint)

$lstOpenPorts           = New-Object System.Windows.Forms.ListBox
$lstOpenPorts.Location  = New-Object System.Drawing.Point(430,10); $lstOpenPorts.Size = New-Object System.Drawing.Size(550,92)
$lstOpenPorts.BackColor = $clrBg; $lstOpenPorts.ForeColor = $clrText; $lstOpenPorts.Font = $fontMono9
$pnlPorts.Controls.Add($lstOpenPorts)

$txtConnInfo            = New-Object System.Windows.Forms.TextBox
$txtConnInfo.Location   = New-Object System.Drawing.Point(12,392); $txtConnInfo.Size = New-Object System.Drawing.Size(992,120)
$txtConnInfo.Multiline  = $true; $txtConnInfo.ReadOnly = $true; $txtConnInfo.ScrollBars = 'Vertical'
$txtConnInfo.BackColor  = $clrPanel; $txtConnInfo.ForeColor = $clrText; $txtConnInfo.Font = $fontMono9
$pnlRem.Controls.Add($txtConnInfo)

$sshTimer          = New-Object System.Windows.Forms.Timer
$sshTimer.Interval = 2000
...
============================  BUYRUQLAR  ============================
  ...
  rdp on | off | status  Remote Desktop'ni yoqish / o'chirish / holati
  ssh on | off | status  OpenSSH Server'ni yoqish / o'chirish / holati
                         (oxiriga 'any' yoki 'local' qo'shsa bo'ladi: rdp on local)
  open port <p> [tcp|udp]   kiruvchi portni ochish (m: open port 8080)
  close port <p> [tcp|udp]  ochilgan portni yopish
...
# ---- Masofaviy kirish (RDP / SSH / portlar) ----
$script:TsKey    = 'HKLM:\SYSTEM\CurrentControlSet\Control\Terminal Server'
$script:SshJob   = $null
$script:SshScope = 'LocalSubnet'

function Get-FwScope { if ($cmbScope.SelectedIndex -eq 1) { return 'Any' } else { return 'LocalSubnet' } }
function Resolve-ScopeArg($s) {
    if ($s -in @('any','hamma','all')) { return 'Any' }
    if ($s -in @('local','lokal','lan')) { return 'LocalSubnet' }
    return (Get-FwScope)
}
function Confirm-Scope($scope, $what) {
    if ($scope -ne 'Any') { return $true }
    $msg = "$what BARCHA manzillarga ochiladi.`n`nOmmaviy Wi-Fi yoki routerda port forwarding bo'lsa, internetdagi har kim parol terib ko'rishi (brute-force) mumkin.`nXavfsizroq yo'l: 'Faqat lokal tarmoq' yoki VPN.`n`nBaribir davom etasizmi?"
    return ([System.Windows.Forms.MessageBox]::Show($msg, "Xavfsizlik ogohlantirishi", 'YesNo', 'Warning') -eq 'Yes')
}

function Get-RdpPort {
    try { return [int](Get-ItemProperty "$script:TsKey\WinStations\RDP-Tcp" -Name PortNumber -ErrorAction Stop).PortNumber } catch { return 3389 }
}
...
function Test-PortListening($port) { return [bool](Get-NetTCPConnection -LocalPort $port -State Listen -ErrorAction SilentlyContinue) }

function Set-AccessRules($prefix, $label, $port, $scope, [switch]$Udp) {
    Remove-NetFirewallRule -Name "$prefix-TCP","$prefix-UDP" -ErrorAction SilentlyContinue
    New-NetFirewallRule -Name "$prefix-TCP" -DisplayName "FWDASH $label TCP $port ($scope)" -Direction Inbound -Action Allow -Protocol TCP -LocalPort $port -RemoteAddress $scope -ErrorAction Stop | Out-Null
    if ($Udp) {
        New-NetFirewallRule -Name "$prefix-UDP" -DisplayName "FWDASH $label UDP $port ($scope)" -Direction Inbound -Action Allow -Protocol UDP -LocalPort $port -RemoteAddress $scope -ErrorAction Stop | Out-Null
    }
}
function Get-AccessFwText($prefix, $builtinName) {
    $r = Get-NetFirewallRule -Name "$prefix-TCP" -ErrorAction SilentlyContinue
    if ($r -and $r.Enabled -eq 'True') { return "ochiq ($((($r | Get-NetFirewallAddressFilter).RemoteAddress) -join ','))" }
    $b = Get-NetFirewallRule -Name $builtinName -ErrorAction SilentlyContinue
    if ($b -and $b.Enabled -eq 'True') { return "ochiq (Windows qoidasi, Any)" }
    return "yopiq"
}

function Enable-Rdp($scope) {
    $ed = (Get-ItemProperty 'HKLM:\SOFTWARE\Microsoft\Windows NT\CurrentVersion' -ErrorAction SilentlyContinue).EditionID
    if ($ed -like 'Core*') { return "Windows Home ($ed) RDP serverini qo'llamaydi. RDP faqat Pro / Enterprise / Education nashrlarida ishlaydi." }
    Set-ItemProperty -Path $script:TsKey -Name fDenyTSConnections -Value 0 -Type DWord -ErrorAction Stop
    Set-ItemProperty -Path "$script:TsKey\WinStations\RDP-Tcp" -Name UserAuthentication -Value 1 -Type DWord -ErrorAction SilentlyContinue
    $port = Get-RdpPort
    # Windows'ning o'z RDP qoidalari hamma manzilga ochiq bo'ladi — ularni o'chirib, o'zimiznikini qo'yamiz
    Get-NetFirewallRule -Name 'RemoteDesktop-*' -ErrorAction SilentlyContinue | Disable-NetFirewallRule -ErrorAction SilentlyContinue
    Set-AccessRules 'FWDASH-RDP' 'RDP' $port $scope -Udp
    try { Start-Service TermService -ErrorAction Stop } catch {}
    return "RDP YOQILDI: port $port (TCP+UDP), ruxsat: $scope, NLA yoqilgan."
}
function Disable-Rdp {
    Set-ItemProperty -Path $script:TsKey -Name fDenyTSConnections -Value 1 -Type DWord -ErrorAction Stop
    Remove-NetFirewallRule -Name 'FWDASH-RDP-TCP','FWDASH-RDP-UDP' -ErrorAction SilentlyContinue
    Get-NetFirewallRule -Name 'RemoteDesktop-*' -ErrorAction SilentlyContinue | Disable-NetFirewallRule -ErrorAction SilentlyContinue
    return "RDP O'CHIRILDI."
}

function Enable-Ssh($scope) {
    if (-not (Get-Service sshd -ErrorAction SilentlyContinue)) { return "OpenSSH Server o'rnatilmagan." }
    Set-Service sshd -StartupType Automatic -ErrorAction Stop
    Start-Service sshd -ErrorAction Stop
    $port = Get-SshPort
    Get-NetFirewallRule -Name 'OpenSSH-Server-In-TCP' -ErrorAction SilentlyContinue | Disable-NetFirewallRule -ErrorAction SilentlyContinue
    Set-AccessRules 'FWDASH-SSH' 'SSH' $port $scope
    return "SSH YOQILDI: port $port, ruxsat: $scope."
}
function Disable-Ssh {
    ...
    Remove-NetFirewallRule -Name 'FWDASH-SSH-TCP','FWDASH-SSH-UDP' -ErrorAction SilentlyContinue
    Get-NetFirewallRule -Name 'OpenSSH-Server-In-TCP' -ErrorAction SilentlyContinue | Disable-NetFirewallRule -ErrorAction SilentlyContinue
    return "SSH O'CHIRILDI."
}
function Install-SshServer {
    if ($script:SshJob) { return "OpenSSH o'rnatilishi allaqachon davom etmoqda..." }
    $script:SshJob = Start-Job -ScriptBlock {
        $cap = Get-WindowsCapability -Online | Where-Object Name -like 'OpenSSH.Server*' | Select-Object -First 1
        if (-not $cap) { throw "OpenSSH.Server komponenti topilmadi." }
        if ($cap.State -ne 'Installed') { Add-WindowsCapability -Online -Name $cap.Name -ErrorAction Stop | Out-Null }
    }
    $sshTimer.Start()
    return "OpenSSH Server o'rnatilmoqda (Windows Update orqali, 1–5 daqiqa)..."
}
function Complete-SshInstall {
    $j = $script:SshJob
    if (-not $j -or $j.State -notin @('Completed','Failed','Stopped')) { return }
    $sshTimer.Stop(); $script:SshJob = $null
    if ($j.State -eq 'Completed') {
        try { Receive-Job $j -ErrorAction Stop | Out-Null; $msg = Enable-Ssh $script:SshScope }
        catch { $msg = "SSH yoqishda xato: $($_.Exception.Message)" }
    } else {
        $reason = $j.ChildJobs[0].JobStateInfo.Reason
        $msg = "OpenSSH o'rnatilmadi: $(if ($reason) { $reason.Message } else { $j.State })"
    }
    Remove-Job $j -Force -ErrorAction SilentlyContinue
    Set-Status $msg; Write-Console $msg; Update-RemoteStatus
}

function Get-RdpState {
    $ed     = (Get-ItemProperty 'HKLM:\SOFTWARE\Microsoft\Windows NT\CurrentVersion' -ErrorAction SilentlyContinue).EditionID
    $isHome = $ed -like 'Core*'
    $deny   = (Get-ItemProperty $script:TsKey -ErrorAction SilentlyContinue).fDenyTSConnections
    $nla    = (Get-ItemProperty "$script:TsKey\WinStations\RDP-Tcp" -ErrorAction SilentlyContinue).UserAuthentication
    $port   = Get-RdpPort
    $on     = (-not $isHome) -and ($deny -eq 0)
    $state  = if ($isHome) { "● MAVJUD EMAS (Windows Home)" } elseif ($on) { "● YOQILGAN" } else { "● O'CHIRILGAN" }
    $lines  = @(
        "Windows nashri : $ed",
        "Port           : $port   tinglayapti: $(if (Test-PortListening $port) { 'ha' } else { "yo'q" })",
        "Firewall       : $(Get-AccessFwText 'FWDASH-RDP' 'RemoteDesktop-UserMode-In-TCP')",
        "NLA            : $(if ($nla -eq 1) { 'yoqilgan' } else { "o'chiq" })"
    )
    return @{ On = $on; Home = $isHome; State = $state; Text = ($lines -join "`r`n") }
}
function Get-SshState {
    $svc  = Get-Service sshd -ErrorAction SilentlyContinue
    $port = Get-SshPort
    if (-not $svc) {
        $t = "OpenSSH Server o'rnatilmagan.`r`n'Yoqish' bosilsa, Windows Update orqali`r`no'rnatiladi (1–5 daqiqa, internet kerak)."
        if ($script:SshJob) { $t += "`r`n`r`n⏳ O'rnatilmoqda..." }
        return @{ On = $false; State = "● O'RNATILMAGAN"; Text = $t }
    }
    $on    = $svc.Status -eq 'Running'
    $lines = @(
        "Xizmat (sshd)  : $($svc.Status) / $($svc.StartType)",
        "Port           : $port   tinglayapti: $(if (Test-PortListening $port) { 'ha' } else { "yo'q" })",
        "Firewall       : $(Get-AccessFwText 'FWDASH-SSH' 'OpenSSH-Server-In-TCP')",
        "Sozlama        : $env:ProgramData\ssh\sshd_config"
    )
    return @{ On = $on; State = $(if ($on) { "● YOQILGAN" } else { "● O'CHIRILGAN" }); Text = ($lines -join "`r`n") }
}

function Open-Port($p, $proto) {
    if (-not $proto) { $proto = 'TCP' }
    $proto = $proto.ToUpper()
    if ($p -notmatch '^\d+(-\d+)?$') { return "Port noto'g'ri (m: 8080 yoki 5000-5100)." }
    if ($proto -notin @('TCP','UDP')) { return "Protokol TCP yoki UDP bo'lishi kerak." }
    $scope = Get-FwScope
    $n = "FWDASH-OPEN-$proto-$p"
    Remove-NetFirewallRule -Name $n -ErrorAction SilentlyContinue
    New-NetFirewallRule -Name $n -DisplayName "FWDASH Open $proto $p ($scope)" -Direction Inbound -Action Allow -Protocol $proto -LocalPort $p -RemoteAddress $scope -ErrorAction Stop | Out-Null
    $warn = if (Get-NetFirewallRule -Name "FWDASH-PORT-$p" -ErrorAction SilentlyContinue) { "  (Diqqat: shu port uchun BLOCK qoidasi bor, u ustun turadi — 'allow port $p' bilan olib tashlang.)" } else { '' }
    return "OCHILDI: $proto $p (ruxsat: $scope)$warn"
}
function Close-Port($p, $proto) {
    if (-not $proto) { $proto = 'TCP' }
    $proto = $proto.ToUpper()
    Remove-NetFirewallRule -Name "FWDASH-OPEN-$proto-$p" -ErrorAction SilentlyContinue
    return "YOPILDI: $proto $p"
}
...
function Get-ConnectInfo {
    ...
    $rp = Get-RdpPort; $sp = Get-SshPort
    $lines = @("Bu kompyuterga boshqa kompyuterdan ulanish:")
    foreach ($ip in $ips) {
        $r = "mstsc /v:$ip$(if ($rp -ne 3389) { ":$rp" })"
        $s = "ssh $env:USERNAME@$ip$(if ($sp -ne 22) { " -p $sp" })"
        $lines += ("  {0,-36} {1}" -f "RDP: $r", "SSH: $s")
    }
    $lines += ""
    $lines += "* Hisobda parol bo'lishi shart. Microsoft hisobi bo'lsa, RDP'da email va parol bilan kiriladi."
    $lines += "* Tashqi internetdan ulanish uchun routerda port forwarding kerak. Xavfsizroq yo'l: VPN (WireGuard, Tailscale)."
...
function Update-RemoteStatus {
    try {
        $r = Get-RdpState
        $cardRdp.State.Text = $r.State; $cardRdp.State.ForeColor = $(if ($r.On) { $clrGreen } else { $clrRed })
        $cardRdp.Detail.Text = $r.Text
        $cardRdp.On.Enabled = -not $r.Home
        $s = Get-SshState
        $cardSsh.State.Text = $s.State; $cardSsh.State.ForeColor = $(if ($s.On) { $clrGreen } else { $clrRed })
        $cardSsh.Detail.Text = $s.Text
        $lstOpenPorts.Items.Clear()
        Get-NetFirewallRule -Name 'FWDASH-OPEN-*' -ErrorAction SilentlyContinue | ForEach-Object {
            [void]$lstOpenPorts.Items.Add(($_.DisplayName -replace '^FWDASH Open ',''))
        }
        if ($lstOpenPorts.Items.Count -eq 0) { [void]$lstOpenPorts.Items.Add("(qo'shimcha ochilgan port yo'q)") }
        $txtConnInfo.Text = Get-ConnectInfo
    } catch { Set-Status "Holat xatosi: $($_.Exception.Message)" }
}
...
function Run-Command($raw) {
    ...
    try {
        ...
        if ($a -in @('rdp','ssh')) {
            $sc = Resolve-ScopeArg $arg
            if ($o -in @('on','yoq','yoqish')) {
                if ($a -eq 'rdp') { Write-Console (Enable-Rdp $sc) }
                elseif (Get-Service sshd -ErrorAction SilentlyContinue) { Write-Console (Enable-Ssh $sc) }
                else { $script:SshScope = $sc; Write-Console (Install-SshServer) }
            } elseif ($o -in @('off','ochir','ochirish')) {
                if ($a -eq 'rdp') { Write-Console (Disable-Rdp) } else { Write-Console (Disable-Ssh) }
            } else {
                $st = if ($a -eq 'rdp') { Get-RdpState } else { Get-SshState }
                Write-Console ("$($a.ToUpper()): $($st.State)`r`n$($st.Text)")
            }
            Update-RemoteStatus; return
        }
        if ($a -in @('open','close') -and $o -eq 'port') {
            $pp = if ($t.Count -ge 3) { $t[2] } else { '' }
            $pr = if ($t.Count -ge 4) { $t[3] } else { 'TCP' }
            if ($a -eq 'open') { Write-Console (Open-Port $pp $pr) } else { Write-Console (Close-Port $pp $pr) }
            Update-RemoteStatus; return
        }
...
# Masofaviy kirish tabi
$btnRemRefresh.Add_Click({ Update-RemoteStatus; Set-Status "Holat yangilandi." })
$tabs.Add_SelectedIndexChanged({ if ($tabs.SelectedTab -eq $tabRemote) { Update-RemoteStatus } })
$sshTimer.Add_Tick({ Complete-SshInstall })
$cardRdp.On.Add_Click({
    $sc = Get-FwScope
    if (-not (Confirm-Scope $sc 'RDP')) { return }
    try { $m = Enable-Rdp $sc } catch { $m = "XATO: $($_.Exception.Message)" }
    Set-Status $m; Update-RemoteStatus
})
$cardRdp.Off.Add_Click({
    try { $m = Disable-Rdp } catch { $m = "XATO: $($_.Exception.Message)" }
    Set-Status $m; Update-RemoteStatus
})
$cardSsh.On.Add_Click({
    $sc = Get-FwScope
    if (-not (Confirm-Scope $sc 'SSH')) { return }
    if (Get-Service sshd -ErrorAction SilentlyContinue) {
        try { $m = Enable-Ssh $sc } catch { $m = "XATO: $($_.Exception.Message)" }
    } else {
        $q = "OpenSSH Server o'rnatilmagan.`nWindows Update orqali o'rnatilsinmi? (1–5 daqiqa, internet kerak)"
        if ([System.Windows.Forms.MessageBox]::Show($q, "OpenSSH", 'YesNo', 'Question') -ne 'Yes') { return }
        $script:SshScope = $sc; $m = Install-SshServer
    }
    Set-Status $m; Update-RemoteStatus
})
$cardSsh.Off.Add_Click({
    try { $m = Disable-Ssh } catch { $m = "XATO: $($_.Exception.Message)" }
    Set-Status $m; Update-RemoteStatus
})
$btnOpenPort.Add_Click({
    if ($cmbScope.SelectedIndex -eq 1 -and -not (Confirm-Scope 'Any' "Port $($txtOpenPort.Text.Trim())")) { return }
    try { $m = Open-Port $txtOpenPort.Text.Trim() $cmbOpenProto.SelectedItem } catch { $m = "XATO: $($_.Exception.Message)" }
    Set-Status $m; Update-RemoteStatus
})
$btnClosePort.Add_Click({
    $p = $txtOpenPort.Text.Trim(); $pr = $cmbOpenProto.SelectedItem
    if (-not $p -and $lstOpenPorts.SelectedItem -match '^(TCP|UDP)\s+(\S+)') { $pr = $Matches[1]; $p = $Matches[2] }
    if (-not $p) { Set-Status "Port kiriting yoki ro'yxatdan tanlang."; return }
    Set-Status (Close-Port $p $pr); Update-RemoteStatus
})
$form.Add_FormClosing({ if ($script:SshJob) { $sshTimer.Stop() } })
